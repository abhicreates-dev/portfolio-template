...
import Github1 from './components/github'
...
function App() {
  return (
    <div className="min-h-screen flex flex-col items-center bg-white dark:bg-[#080808] text-gray-900 dark:text-white transition-colors duration-300">
      <ModeToggle />
      <main className="w-full max-w-3xl h-full border border-dashed border-black/50 dark:border-white/10">
        ...
        <div className="relative">
          ...
          <img
            src='https://pbs.twimg.com/profile_images/1950503002458210305/w5HwOGa__400x400.jpg'
            alt="Profile"
            className="
              hidden sm:block
              rounded-full border p-[2px]  border-gray-200 dark:border-[#080808]
          ...
          <div className="hidden sm:block absolute left-[19%] mt-1">
            <h1 className="tracking-tight font-medium text-lg sm:text-xl md:text-2xl">
              Abhishek Salunke
            </h1>
            <div className="text-sm font-light mt-[0.5px] secondary"><TypingText /></div>
          </div>
        </div>
        ...
        <p className="text-sm sm:text-base font-light secondary leading-snug imp">
          I design and build interfaces. <span>frontend with a design engineer’s mindset.</span>{' '}
          I work in <span>TypeScript</span>, focusing on <span>clean UI, smooth interactions,</span> and performance.
          {' '}I care about <span>details, systems, and shipping things</span> that feel right.
          {' '}and I call myself a <span>Artist</span>
        </p>
        </div>
        ...
        <div className="m-5 mt-8 sm:mt-12 saturate-0 invert-100 dark:invert-0 overflow-x-auto">
          <GitHubCalendar className='' username="nagmani001" />
        </div>
